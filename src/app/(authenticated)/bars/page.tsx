...
const BarImage = styled.div`
  height: 160px; width: 100%; position: relative; overflow: hidden; background: #262626;
          ...
          <BarCard key={venue.id} onClick={() => router.push(`/venues/${venue.id}`)}>
            {venue.imageUrl ? (
              <BarImage>
                ...
                <div style={{ position: "absolute", top: "10px", left: "10px", background: "rgba(0,0,0,0.6)", backdropFilter: "blur(4px)", color: "#fff", fontSize: "10px", fontWeight: 600, padding: "3px 8px", borderRadius: "6px", display: "inline-flex", alignItems: "center", gap: "4px" }}>
